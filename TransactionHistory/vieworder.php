...
<div align="center">
	...
	$_SESSION["url"] = "../TransactionHistory/transhis.php";
		 ...
		 $id = $_GET["id"];
		 $result = mysqli_query($con,"SELECT * FROM  `b_o` WHERE  `order_id` = '$id'");
		 echo "<hr>";
 		 echo "<h2>";
 		 echo "Contents of order no $id";
  		 echo "</h2>";
		 echo "<table border='1'>
     	<col width='250'>
         <col width='250'>
		 <tr>
			...
			while($row = mysqli_fetch_array($result))
			{
				...
				echo "<a href='../Product Page/download.php?id=$bookid'>";
				echo $row['book_id'];
				echo "</a>";
				echo '</td>';
