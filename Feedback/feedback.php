...
<div align="center">
	...
	<div  id="maindiiv" align="center">
    	<div id="mainnav" align="center" >
			...
			if($name==" "){
	session_start();
	$_SESSION["url"] = "../Feedback/feedback.php";
         ...
         <div id="bodymain">
         <!-------------Code below------------------>
         <p><h1><b>Questions?</b></h1></p>
         <hr style="width:600px">
		 <p><h3>Submit here. One of our admins will help you out!</h3></p>
         ...
         <table id="feedback">
			...
			<tr>
                ...
                <td>
                <?php
						echo "<input type='email' name='email' value='$row[1]'; style='width:440px'/>";
				?>
                 
            </tr>
			<tr>
				<td align="right"> Question : </td>
				<td><textarea name="question" rows="10" cols="60"></textarea> </td>
			</tr>
			<tr>
			<td> </td><td>
			<?php
        ...
        ?>
         ...
         <br>
         <input type="submit" name="submit" value="Submit" onclick="return formValidate()"/>
         </form>
