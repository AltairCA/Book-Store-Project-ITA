...
<script>
function pwmatch() {
    var ask = window.alert("Passwords do not match, please re-enter.");
    if (ask) {
...
function pwnull() {
    var ask = window.alert("Password cannot be empty, please fill both fields.");
    if (ask) {
...
function success() {
    var ask = window.alert("Successfully updated password!");
    if (ask) {
...
<div align="center">
	...
	<div  id="maindiiv" align="center">
    	<div id="mainnav" align="center" >
         ...
         <!-------------Code below------------------>
         <?php
$pass1 = mysqli_real_escape_string($con, $_POST['pword']);
$pass2 = mysqli_real_escape_string($con, $_POST['confpword']);
if((($pass1 == NULL)||($pass1 == ""))&&(($pass2 == NULL)||($pass2 == "")))
{
	echo '<script type="text/javascript">', 'pwnull();', '</script>';
}
else
{
if($pass1 == $pass2)
...
{
	echo '<script type="text/javascript">', 'pwmatch();', '</script>';
