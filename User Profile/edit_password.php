...
<div align="center">
	...
	<div  id="maindiiv" align="center">
    	<div id="mainnav" align="center" >
         ...
         <hr>
          <form  name="password" method="post" action="insertpassword.php"  >
          <table>
		<tr>
			<td>New Password: </td>
		...
		<tr>
			...
			<td><input type="password" name="confpword" >
			</td>
		</tr>
			
		<tr>
			
			<p>Enter a new password for your user account. *Note that passwords are case sensitive.</p>
			
		</tr>
		
		<tr>

			<td><input type="submit" name="Save_Changes" value="Save Changes" > </td>
			<td><input  type="reset" name="Reset Fiels"  value="Reset Fiels"></td>
		
        
        <td><a href="edit_profile.php"><input type="button" value="Back"></a></td>
		</tr> 	
