...
<a href="/">Audio Books</a>
		   ...
		   <div align="left" id="books">
			 ...
			 $cart_query = mysql_query("SELECT * FROM `book` order by(id) DESC",$con);
				...
				for($x=0;$x<4;$x++){
					...
					<span style='position:absolute; top:".(292+($x*245))."px; left:250px;'><image width='139px' height='211px' src=$b_path></span>
	<span style='position:absolute; top:".(304+($x*244))."px; left:400px;'>".$b_name."</span>
			 ...
			 <span style='position:absolute; top:".(324+($x*245))."px;; left:788px; width: 128px; height: 65px; color: #093; font-size: xx-large; font-family: 'Times New Roman';'><strong>".$dollar."".$b_price."</strong></span>";
