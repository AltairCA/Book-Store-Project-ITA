...
//mysql_connect("localhost","root","sparksndl") or die(mysql_error());
...
$output=$output.("<a href='../Product Page/download.php?id=$row[0]'><img width='139px' height='211px' src='$path'><br><div>$bname By $auth</div><br></a>");
...
<div align="center">
	...
	<div  id="maindiiv" align="center">
    	<div id="mainnav" align="center" >
		 ...
		 <hr>
		 <h3 style="text-transform:uppercase">Search Results: <?php
		  error_reporting(0);
		 $test=' possible search results..';
		print("$count");
		print("$test");	
		?></h3>
		...
		?>
         ...
         <center>Copyright © WeBooks! All rights reserved.</center><footer>
	 	</div>
